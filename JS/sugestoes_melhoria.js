document.addEventListener('DOMContentLoaded', () => {
    ...
    async function carregar_sugestoesVotacao(){
        ...
        try {
            ...
            const dados_filtrados = Array.isArray(sugestoes) ? sugestoes.filter(sug => sug.tipo === 'Sugestão de melhoria') : [];
                ...
                if (sug){
                    ...
                    cards_HTML += `
                        <div class="bloco_votacao">
                            <div class="card_melhoria card_estrutura_votacao">
                    ...
                    cards_HTML += `
                        <div class="bloco_votacao">
                            <div class="card_melhoria card_estrutura_votacao vazio"></div>
